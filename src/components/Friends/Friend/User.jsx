  ...
  return (
    <div className='h-[158px] flex p-3 gap-4 border w-[450px]'>
      <div className=''>
        ...
        <button
          className='p-2 text-white bg-indigo-700 w-[100px] mt-3 rounded-lg disabled:opacity-[0.7]'
          onClick={apiToggleFollow}
      ...
      <div className='flex-1 flex-shrink-0 max-h-full max-w-full'>
        <Link className='text-indigo-700 font-bold text-lg font-anton' to={link}>
          {name}
        </Link>
